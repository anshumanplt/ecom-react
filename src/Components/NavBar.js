    ...
    return (
        ...
        <div className="header-bottom sticky-header">
            <div className="container">
                                        ...
                                        <div className="demo-list">
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-25.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/25.jpg")' }} ></span>
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-26.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/26.jpg")' }} ></span>
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-27.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/27.jpg")' }}></span>
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-28.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/28.jpg")' }} ></span>
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-29.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/29.jpg")' }} ></span>
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-30.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/30.jpg")' }} ></span>
                                            ...
                                            <div className="demo-item hidden">
                                                <a href="index-31.html">
                                                    <span className="demo-bg" style={{ backgroundImage : 'url("assets/images/menu/demos/31.jpg")' }} ></span>
                ...
                <div className="header-right">
                    <i className="la la-lightbulb-o"></i><p>Clearance Up to <span>30% Off</span></p>
                </div>
            </div>
        </div>
    </header>
